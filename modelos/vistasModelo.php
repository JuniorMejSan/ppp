...
class vistasModelo{
    ...
    protected static function obtener_vistas_modelo($vista){
        ...
        $listaBlanca = ["home", "client-list", "client-new", "client-search", "client-update", "item-list", "item-list-disable", "item-new", "item-search", "item-update", "item-reporte", "item-vencimiento", "venta-list", "venta-new", "venta-search", "venta-reporte", "user-list", "user-new", "user-search", "user-update", "proveedor-new", "proveedor-list", "proveedor-search", "proveedor-update", "compra-list", "compra-new", "compra-search", "compra-reporte", "presentacion-new", "presentacion-list", "presentacion-list-disable", "presentacion-update", "medio-new", "medio-list", "medio-list-disable", "medio-update", "reporte-ventas", "reporte-compras"];

...
class vistasModelo{
    ...
    protected static function obtener_vistas_modelo($vista){
        ...
        $listaBlanca = ["home", "client-list", "client-new", "client-search", "client-update", "empresa", "item-list", "item-new", "item-search", "item-update", "reservation-list", "reservation-new", "reservation-pending", "reservation-reservation", "reservation-search", "reservation-update", "user-list", "user-new", "user-search", "user-update"];

...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo server_url; ?>venta-venta/"><i class="far fa-calendar-alt"></i> &nbsp;
                RESERVACIONES</a>
        </li>
        <li>
        ...
        <li>
            <a href="<?php echo server_url; ?>ventalass="fas fa-clipboard-list fa-fw"></i> &nbsp; FINALIZADOS</a>
        </li>
        <li>

...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo server_url; ?>presentacion-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE
...
<?php
    ...
    echo $ins_item->paginador_presentacion_controlador($pagina[1],15, $_SESSION['privilegio_ppp'], $pagina[0], 'Habilitado');
?>
</div>
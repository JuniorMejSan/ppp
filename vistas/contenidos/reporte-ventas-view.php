...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-chart-pie"></i> &nbsp; REPORTE DE VENTAS
    </h3>
    <p class="text-justify">
        FILTRO AVANZADO DE VENTAS
    </p>
</div>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active" href="<?php echo server_url; ?>venta-reporte/"><i class="fas fa-chart-pie"></i> &nbsp; REPORTE</a>
        </li>
    </ul>
</div>
...
<div class="container-fluid">
    <form class="form-neon" id="formularioReporteVentas" method="POST" autocomplete="off">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="reporte_medio_pago" id="reporte_medio_pago">
                            ...
                            <?php
                                ...
                                $metodos = $ins_venta->obtener_metodos_pago();
            ...
            <div class="row">
                <div class="col-12">
                    <p class="text-center" style="margin-top: 20px;">
                        <button type="button" class="btn btn-raised btn-info" onclick="filtrar_reporte_ventas(1)">
                            <i class="fas fa-search"></i> &nbsp; FILTRAR
                        </button>
                        <button type="button" class="btn btn-raised btn-danger" onclick="limpiar_filtros_reporte()">
...
<div class="container-fluid" style="margin-top: 30px;">
    <div id="contenedor_reporte_ventas">
...
<?php
    include_once "./vistas/inc/reporte_ventas.php";
?>

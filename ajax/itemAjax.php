...
if (isset($_POST['item_codigo_reg']) || isset($_POST['item_id_del']) || isset($_POST['item_id_enable']) || isset($_POST['item_id_up']) || (isset($_POST['accion']) && $_POST['accion'] == 'obtener_datos_grafico') || (isset($_POST['accion']) && $_POST['accion'] == 'obtener_datos_stock') || (isset($_POST['accion']) && $_POST['accion'] == 'obtener_vendidos_grafico')) { //si se esta enviando datos desde un formulario, puede ser registrar, elimiar o actualizar

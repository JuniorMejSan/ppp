...
if (isset($_POST['proveedor_ruc_reg']) || isset($_POST['proveedor_id_del']) || isset($_POST['proveedor_id_up'])) { //si se esta enviando datos desde un formulario, puede ser registrar, elimiar o actualizar
